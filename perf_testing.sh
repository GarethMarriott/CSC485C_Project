...
perf stat -d -d -d ./$1 1000-100matrix.txt
echo 1000-100 done
perf stat -d -d -d ./$1 1000-10matrix.txt
echo 1000-10 done
perf stat -d -d -d ./$1 1000-4matrix.txt
echo 1000-4 done
perf stat -d -d -d ./$1 1000-2matrix.txt
echo 1000-2 done
perf stat -d -d -d ./$1 2000-100matrix.txt
echo 2000-100 done
perf stat -d -d -d ./$1 2000-10matrix.txt
echo 2000-10 done
perf stat -d -d -d ./$1 2000-4matrix.txt
echo 2000-4 done
perf stat -d -d -d ./$1 2000-2matrix.txt
echo 2000-2 done
perf stat -d -d -d ./$1 3000-100matrix.txt
echo 3000-100 done
perf stat -d -d -d ./$1 3000-10matrix.txt
echo 3000-10 done
perf stat -d -d -d ./$1 3000-4matrix.txt
echo 3000-4 done
perf stat -d -d -d ./$1 3000-2matrix.txt
echo 3000-2 done
perf stat -d -d -d ./$1 4000-100matrix.txt
echo 4000-100 done
perf stat -d -d -d ./$1 4000-10matrix.txt
echo 4000-10 done
perf stat -d -d -d ./$1 4000-4matrix.txt
echo 4000-4 done
perf stat -d -d -d ./$1 4000-2matrix.txt
echo 4000-2 done
